...
public class DInterUnits {
 ...
 refate, t2, recursion,
 //other
 timeAssemblyDrone, decayAssemblyDrone, rush, timeEntity, end
            ;
 public static void load(){
    ...
    weapons.add(new Weapon("main-day-weap"){{
        ...
        weapons.add(new Weapon("decay-inter-sub-day-weap"){{
            ...
            bullet = new ContinuousLaserBulletType(){{
                    ...
                    damage = 25f;
                    drawSize = 80f;
                    colors = new Color[]{DecayPal.darkTime.cpy().a(.2f), DecayPal.midTime.cpy().a(.5f), DecayPal.midTime.cpy().mul(1.2f), DecayPal.lightTime};
            }};
    ...
    outlineColor = DecayPal.decalOutline;
        weapons.add(
                new Weapon("decal-sub-year-weap"){{
                    reload = 70f;
                    x = 0f;
                    y = -6.5f;
                    shootY = 0f;
                ...
                new Weapon("main-year-weap"){{
                    ...
                    bullet = new LaserBulletType() {{
                        ...
                        sideWidth = 0f;
                        sideLength = 0f;
                        colors = new Color[]{DecayPal.darkTime.cpy().a(0.4f), DecayPal.midTime, DecayPal.lightTime};
                    }};
                }});
    }};
    //alt time units
