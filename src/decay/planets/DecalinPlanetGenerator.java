...
public class DecalinPlanetGenerator extends PlanetGenerator {
	...
	public void addWeather(Sector sector, Rules rules){
		Weather.WeatherEntry weather = new Weather.WeatherEntry(DInterWeather.decayStorm);
		Weather.WeatherEntry weather2 = new Weather.WeatherEntry(DInterWeather.timePressure);
	...
	public void decStart(int ix, int iy, int rad) {
		Floor floor = DInterBlocks.decayfloor.asFloor();
