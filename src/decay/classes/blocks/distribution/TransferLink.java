...
public class TransferLink extends Block {
    ...
    public void load() {
        super.load();
        arrowRegion = Core.atlas.find("decay-inter-link-arrow");
        laserRegion = Core.atlas.find("decay-inter-link-laser");
        laserEndRegion = Core.atlas.find("decay-inter-link-laser-end");
    }
